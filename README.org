...
sudo dnf install git cmake gcc-c++ extra-cmake-modules kwin-devel qt6-qtbase-devel kf6-kconfigwidgets-devel kf6-kcmutils-devel libepoxy-devel wayland-devel libdrm-devel
